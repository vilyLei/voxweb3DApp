...
import { DracoTaskListener } from "./draco/DracoTask";
 ...
 */
class App extends AppBase implements IApp,DracoTaskListener{
     ...
     */
    run(): void {
        //if(this.m_dracoRawTask != null && this.m_threadModule != null) {
            //this.m_threadModule.run();
        //}
