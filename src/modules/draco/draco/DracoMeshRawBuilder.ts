...
class DracoMeshRawBuilder {
    ...
    threadTask: ThreadSystemTask = null;
    ...
    private onWasmLoaded(data: any): void {
        ...
        this.m_dracoTask = new DracoTask(this.threadSystem, this.threadTask, this.m_threadsTotal );
        this.threadSystem.initializeThread(this.m_threadsTotal, data.wapper);
        this.threadSystem.initTaskByCodeStr(this.m_dracoParserStr + this.m_dracoThreadStr, 1, "ThreadDraco");
