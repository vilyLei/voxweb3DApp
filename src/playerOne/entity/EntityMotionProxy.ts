...
class EntityMotionProxy
{
    ...
    update():void
    {
        ...
        if(this.moveEnabled)
        {
            ...
            if(this.spx > 0.0)
            {
                if(po_px > EntityMotionProxy.MaxV.x)
                {
                    this.spx *= -1.0;
                    po_px = this.px;
                }
            ...
            {
                if(po_px < EntityMotionProxy.MinV.x)
                {
                    this.spx *= -1.0;
                    po_px = this.px;
                }
            ...
            if(this.spy > 0.0)
            {
                if(po_py > EntityMotionProxy.MaxV.y)
                {
                    this.spy *= -1.0;
                    po_py = this.py;
                }
            ...
            {
                if(po_py < EntityMotionProxy.MinV.y)
                {
                    this.spy *= -1.0;
                    po_py = this.py;
                }
            ...
            if(this.spz > 0.0)
            {
                if(po_pz > EntityMotionProxy.MaxV.z)
                {
                    this.spz *= -1.0;
                    po_pz = this.pz;
                }
            ...
            {
                if(po_pz < EntityMotionProxy.MinV.z)
                {
                    this.spz *= -1.0;
                    po_pz = this.pz;
                }
