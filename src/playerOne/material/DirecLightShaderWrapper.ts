...
class DirecLightShaderWrapper implements IShdWrapper {

    constructor(){
        
        console.log("DirecLightShaderWrapper constructor()...");
    }
    initialize(): void {
    ...
    getFragShaderCode(codeBuilder: IShdBuilder): string {
        ...
        console.log("DirecLightShaderWrapper getFragShaderCode()...",codeBuilder);
        codeBuilder.reset();
...
export {DirecLightShaderWrapper};